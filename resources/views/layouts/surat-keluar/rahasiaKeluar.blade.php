...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Rahasia Keluar</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<div class="container mt-2">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-inline" method="GET" action="{{ route('surat-masuk-rahasiaKeluar.index') }}">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <!-- Loop data surat -->
                    @foreach ($rahasiaKeluar as $surat)
                    <tr>
                        <td>{{ $surat->nomor }}</td>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route('surat-keluar-rahasiaKeluar.destroy', $surat->id) }}" class="d-inline" onsubmit="return confirmDelete()">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal fade" id="editSuratModal{{ $surat->id }}" tabindex="-1" role="dialog" aria-labelledby="editSuratModalLabel{{ $surat->id }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{ route('surat-keluar-rahasiaKeluar.update', $surat->id) }}">
                                    @csrf
                                    @method('PUT')
...
<div class="modal fade" id="addSuratModal" tabindex="-1" role="dialog" aria-labelledby="addSuratModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('surat-keluar-rahasiaKeluar.store') }}">
                @csrf
                <div class="modal-header">
