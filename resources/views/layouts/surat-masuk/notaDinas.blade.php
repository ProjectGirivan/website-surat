...
<div class="content-header">
    ...
    <div class="container mt-2">
        ...
        <div class="row">
            ...
            <form class="form-inline" method="GET" action="{{ route('surat-masuk-notaDinas.index') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ route('surat-masuk-notaDinas.destroy', $surat->id) }}" class="d-inline" onsubmit="return confirmDelete()">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="modal fade" id="editStudentModal{{ $surat->id }}" tabindex="-1" role="dialog" aria-labelledby="editStudentModalLabel{{ $surat->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="POST" action="{{ route('surat-masuk-notaDinas.update', $surat->id) }}">
                                        @csrf
                                        @method('PUT')
    ...
    <div class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="addStudentModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('surat-masuk-notaDinas.store') }}">
                    @csrf
                    <div class="modal-header">
