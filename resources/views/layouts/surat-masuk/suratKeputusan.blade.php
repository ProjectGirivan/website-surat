...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Surat Keputusan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <!-- Loop data surat -->
                    @foreach ($suratKeputusan as $surat)
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route('surat-masuk-suratKeputusan.destroy', $surat->id) }}" class="d-inline">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal fade" id="editStudentModal{{ $surat->id }}" tabindex="-1" role="dialog" aria-labelledby="editStudentModalLabel{{ $surat->id }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{ route('surat-masuk-suratKeputusan.update', $surat->id) }}">
                                    @csrf
                                    @method('PUT')
...
<div class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="addStudentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('surat-masuk-suratKeputusan.store') }}">
                @csrf
                <div class="modal-header">
