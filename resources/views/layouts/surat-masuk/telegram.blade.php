    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                ...
                <form class="form-inline" method="GET" action="{{ route('surat-masuk-telegram.index') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route('surat-masuk-telegram.destroy', $surat->id) }}" class="d-inline" onsubmit="return confirmDelete()">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal fade" id="editStudentModal{{ $surat->id }}" tabindex="-1" role="dialog" aria-labelledby="editStudentModalLabel{{ $surat->id }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{ route('surat-masuk-telegram.update', $surat->id) }}">
                                    @csrf
                                    @method('PUT')
...
<div class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="addStudentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('surat-masuk-telegram.store') }}">
                @csrf
                <div class="modal-header">
