...
@section('konten')
    ...
    <div class="content-header">
          ...
          <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <form class="form-inline" method="GET" action="{{ route('surat-masuk-suratBiasa.index') }}">
                        @include('layouts.surat-masuk.search.search')
                    </form>
                    </div>         
      
                  <table id="bootsrap-data-table" class="table table-striped table-bordered" data-page-length='50'>
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  <form method="POST" action="{{ route('surat-masuk-suratBiasa.destroy', $surat->id) }}" class="d-inline">
                                      @csrf
                                      @method('DELETE')
                          ...
                          <div class="modal fade" id="editStudentModal{{ $surat->id }}" tabindex="-1" role="dialog" aria-labelledby="editStudentModalLabel{{ $surat->id }}" aria-hidden="true">
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      <form method="POST" action="{{ route('surat-masuk-suratBiasa.update', $surat->id) }}">
                                          @csrf
                                          @method('PUT')
      ...
      <div class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="addStudentModalLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                  <form method="POST" action="{{ route('surat-masuk-suratBiasa.store') }}">
                      @csrf
                      <div class="modal-header">
