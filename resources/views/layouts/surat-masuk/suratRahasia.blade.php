    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                ...
                <form class="form-inline" method="GET" action="{{ route('surat-masuk-suratRahasia.index') }}">
                    @include('layouts.surat-masuk.search.search')
                </form>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route('surat-masuk-suratRahasia.destroy', $surat->id) }}" class="d-inline">
                                @csrf
                                @method('DELETE')
...
<div class="modal fade" id="editSuratModal{{ $surat->id }}" tabindex="-1" role="dialog" aria-labelledby="editSuratModalLabel{{ $surat->id }}" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('surat-masuk-suratRahasia.update', $surat->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">                    
                    ...
                    <div class="form-group">
                        <label for="keterangan"><i class="fas fa-address-card"></i> Keterangan</label>
                        <input type="text" name="keterangan" id="keterangan" value="{{ $surat->keterangan }}" class="form-control" required>
                    </div>
                </div>
...
<div class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="addStudentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('surat-masuk-suratRahasia.store') }}">
                @csrf
                <div class="modal-header">
